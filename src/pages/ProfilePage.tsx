...
import { formatNumber as formatCount, displayName } from '../utils/formatter';
...
export default function ProfilePage() {
  ...
  if (!currentUser) return <FullPageLoader message="Loading profile..." />;
  ...
  const isLiked     = likedUsers.has(profileUserId);
  const profileInterests = profileUser.interests ?? [];
      ...
      <div className="card" style={{
          ...
          {!isOwn && (
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                ...
                onClick={() => toggleUserLike(profileUserId)}
              >
        ...
        {profileInterests.length > 0 && (
          <div style={{ marginBottom: 18 }}>
            <TagList tags={profileInterests} max={6} />
          </div>
        )}
        ...
        <div style={{
          ...
          {[
            ...
            { label: 'Posts',     value: profileUser.posts ?? 0 },
          ].map((stat, i) => (

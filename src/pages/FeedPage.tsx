      ...
      {isAuth ? (
        <div className="card" style={{ padding: 16 }}>
          ...
          >
            <img
              ...
              alt={currentUser?.firstName || "Current user"}
              style={{
                width: 40,
                height: 40,
                borderRadius: "50%",
          ...
          >
            {[
              {
                icon: <PhotoIcon style={{ width: 18, height: 18 }} />,
                label: "Photo",
              },
              {
                icon: <VideoCameraIcon style={{ width: 18, height: 18 }} />,
                label: "Video",
              },
              {
        ...
        <div
          ...
          style={{
            padding: "20px 24px",
            background:
              "linear-gradient(135deg, var(--primary-dim) 0%, var(--accent-dim) 100%)",
        ...
        >
          ...
          >
            ...
            >
              <LockClosedIcon
                style={{ width: 20, height: 20, color: "var(--primary-light)" }}
              />
            </div>
      ...
      {posts.length > 0 ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {posts.map((post, index) => (
            <PostCard key={post.id} post={post} delay={index * 60} />
          ))}
        </div>
      ) : (
        <EmptyState

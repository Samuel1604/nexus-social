...
import { useSocialContext as useSocial } from "../../context/SocialContext";
...
export default function Topbar() {
  ...
  const title = PAGE_TITLES[pathname as keyof PageTitles] || "Nextcord";
  const createModal = CREATE_MAP[pathname as keyof CreateMap] || null;

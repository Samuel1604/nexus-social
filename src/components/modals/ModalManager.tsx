...
import { Modal, RatingStars } from "../ui/UIComponents";
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div>
          ...
          <input
            className="input-base"
            placeholder="e.g. React Developers NG"
            value={form.name}
            onChange={(e) => set("name", e.target.value)}
          />
        </div>
...
export function SubscribeModal() {
  ...
  const channel = modalData as Channel | null;
        ...
        {confirmed ? (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: 14 }}>
              You now have access to {channel.name}
            </p>
          </div>
        ) : (
          <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <span
            style={{
              fontSize: 12,
              color: remaining < 50 ? "var(--red)" : "var(--text-muted)",
            }}
          >
...
const ROOM_COLORS = [
  ...
  {
    value: "from-cyan-500 to-teal-600",
    preview: "linear-gradient(135deg,#06b6d4,#0d9488)",
  },
  {
  ...
  },
  {
    ...
    preview: "linear-gradient(135deg,#ec4899,#e11d48)",
  },
  {
    value: "from-green-500 to-emerald-600",
    preview: "linear-gradient(135deg,#22c55e,#059669)",
  },
];
